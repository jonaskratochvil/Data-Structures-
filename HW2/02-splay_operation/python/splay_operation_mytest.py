...
def test_remove():
    # Test validity first
    tree = Tree()
    sequence = [2 * pow(997, i, 199) for i in range(1, 199)]
    ...
    # Existing elements
    for elem in range(2, 1000, 2):
        tree.remove(elem)

# tests = [("splay", test_splay),("lookup", test_lookup),("insert", test_insert), ("remove", test_remove)]
